...
define("SMTP_UNAME", "sieunhankubetv@gmail.com"); //Username for SMTP authentication any valid email created in your domain
define("SMTP_PWORD", "rrpjgzhhuslapzyy"); //Password for SMTP authentication
